...
import 'package:medisafe/controller/HistoriqueDozeController.dart';
                ...
                child: FutureBuilder<User>(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.done) {
                      if (snapshot.hasData &&
                          snapshot.data!.toMap().isNotEmpty) {
...
class _HomeScreenContentState extends State<HomeScreenContent>
  ...
  DatabaseHelper databaseHelper = DatabaseHelper.instance;
  final histoController = getIt<HistoriqueDozeController>();
            ...
            return InkWell(
              onTap: () {
                ...
                HistoriqueDoze historiqueDoze = HistoriqueDoze(
                    ...
                    datePrevu: "");
                if (selectedDay
                        .getCurentdateB(medicamentDoze[index].doze!.heure)
                                                        ...
                                                        InkWell(
                                                            onTap: () async {
                                                              ...
                                                              historiqueDoze
                                                                  .id = id;
                                                                  try{
                                                                histoController.createRendezVous(historiqueDoze, 1);
